...
const supabaseUrl = 'https://cfguzyejrhfzzrrsxexw.supabase.co';
const supabaseKey = process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImNmZ3V6eWVqcmhmenpycnN4ZXh3Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTY2OTc3NTMsImV4cCI6MjA3MjI3Mzc1M30.3PrfFkwdfGLGE0xi9B0BhZpXIqA31Oed2FKpgrFDmU4';
